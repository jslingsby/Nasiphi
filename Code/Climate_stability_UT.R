...
############# using untransformed vegetation #######
############## Heller et al. 2015 ##################
...
pu <- readGDAL("Data/westcoast.asc") 
names(pu@data)<-"pu"
...
write.csv(climstab, "Output/UT/rcp45/climstabvegbcc65.csv")
rm(bcc65)
#########################################
...
#write results to a table
write.csv(climstab, "Output/UT/rcp45/climstabvegbcc100.csv")
rm(bcc100)
#########################################
##############
#BNUESM100
...
#write results to a table
write.csv(climstab, "Output/UT/rcp45/climstabvegBNUESM100.csv")
rm(BNUESM100)
#########################################
##############
#BNUESM65
...
#write results to a table
write.csv(climstab, "Output/UT/rcp45/climstabvegBNUESM65.csv")
rm(BNUESM65)
#########################################
##############
#CanESM100
...
#write results to a table
write.csv(climstab, "Output/UT/rcp45/climstabvegCanESM100.csv")
rm(CanESM100)
#########################################
##############
#CanESM65
...
#write results to a table
write.csv(climstab, "Output/UT/rcp45/climstabvegCanESM65.csv")
rm(CanESM65)
#########################################
##############
#CNRMCM100
...
#write results to a table
write.csv(climstab, "Output/UT/rcp45/climstabvegCNRMCM100.csv")
rm(CNRMCM100)
#########################################
##############
#CNRMCM65
...
#write results to a table
write.csv(climstab, "Output/UT/rcp45/climstabvegCNRMCM65.csv")
rm(CNRMCM65)
#########################################
##############
#FGOALSs100
...
#write results to a table
write.csv(climstab, "Output/UT/rcp45/climstabvegFGOALSs100.csv")
rm(FGOALSs100)
###################################################
##############
#FGOALSs65
...
#write results to a table
write.csv(climstab, "Output/UT/rcp45/climstabvegFGOALSs65.csv")
rm(FGOALSs65)
#########################################################
##############
#GFDL65
...
#write results to a table
write.csv(climstab, "Output/UT/rcp45/climstabvegGFDL65.csv")
rm(GFDL65)
#######################################################
##############
#GFDL100
...
#write results to a table
write.csv(climstab, "Output/UT/rcp45/climstabvegGFDL100.csv")
rm(GFDL100)
##############
#GFDLESM100
##########
...
#write results to a table
write.csv(climstab, "Output/UT/rcp45/climstabvegGFDLESM100.csv")
rm(GFDLESM100)
#######################################################
##############
#GFDLESM65
...
#write results to a table
write.csv(climstab, "Output/UT/rcp45/climstabvegGFDLESM65.csv")
rm(GFDLESM65)
#######################################################
##############
#MIROC65
...
#write results to a table
write.csv(climstab, "Output/UT/rcp45/climstabvegMIROC65.csv")
rm(MIROC65)
#######################################################
##############
#MIROC100
...
#write results to a table
write.csv(climstab, "Output/UT/rcp45/climstabvegMIROC100.csv")
rm(MIROC100)
##############
#MIROCES100
##########
...
#write results to a table
write.csv(climstab, "Output/UT/rcp45/climstabvegMIROCES100.csv")
rm(MIROCES100)
#######################################################
##############
#MIROCES65
...
#write results to a table
write.csv(climstab, "Output/UT/rcp45/climstabvegMIROCES65.csv")
rm(MIROCES65)
#######################################################
##############
#MIROCHEM65
...
#write results to a table
write.csv(climstab, "Output/UT/rcp45/climstabvegMIROCHEM65.csv")
rm(MIROCHEM65)
#######################################################
##############
#MIROCHEM100
...
#write results to a table
write.csv(climstab, "Output/UT/rcp45/climstabvegMIROCHEM100.csv")
rm(MIROCHEM100)
#######################################################
##############
#MRIC100
...
#write results to a table
write.csv(climstab, "Output/UT/rcp45/climstabvegMRIC100.csv")
rm(MRIC100)
#######################################################
##############
#MRIC65
...
#write results to a table
write.csv(climstab, "Output/UT/rcp45/climstabvegMRIC65.csv")
rm(MRIC65)
#######################################################
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegbcc65.csv")
rm(bcc65)
#########################################
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegbcc100.csv")
rm(bcc100)
#########################################
##############
#BNUESM100
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegBNUESM100.csv")
rm(BNUESM100)
#########################################
##############
#BNUESM65
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegBNUESM65.csv")
rm(BNUESM65)
#########################################
##############
#CanESM100
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegCanESM100.csv")
rm(CanESM100)
#########################################
##############
#CanESM65
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegCanESM65.csv")
rm(CanESM65)
#########################################
##############
#CNRMCM100
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegCNRMCM100.csv")
rm(CNRMCM100)
#########################################
##############
#CNRMCM65
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegCNRMCM65.csv")
rm(CNRMCM65)
#########################################
##############
#FGOALSs100
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegFGOALSs100.csv")
rm(FGOALSs100)
###################################################
##############
#FGOALSs65
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegFGOALSs65.csv")
rm(FGOALSs65)
#########################################################
##############
#GFDL65
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegGFDL65.csv")
rm(GFDL65)
#######################################################
##############
#GFDL100
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegGFDL100.csv")
rm(GFDL100)
##############
#GFDLESM65
##########
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegGFDLESM65.csv")
rm(GFDLESM65)
#######################################################
##############
#GFDLESM100
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegGFDLESM100.csv")
rm(GFDLESM100)
#######################################################
##############
#MIROC65
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegMIROC65.csv")
rm(MIROC65)
#######################################################
#######################################################
##############
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegMIROC100.csv")
rm(MIROC100)
##############
#MIROCES100
##########
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegMIROCES100.csv")
rm(MIROCES100)
#######################################################
##############
#MIROCES65
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegMIROCES65.csv")
rm(MIROCES65)
#######################################################
##############
#MIROCHEM65
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegMIROCHEM65.csv")
rm(MIROCHEM65)
#######################################################
##############
#MIROCHEM100
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegMIROCHEM100.csv")
rm(MIROCHEM100)
#######################################################
##############
#MRIC100
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegMRIC100.csv")
rm(MRIC100)
#######################################################
##############
#MRIC65
...
#write results to a table
write.csv(climstab, "Output/UT/rcp85/climstabvegMRIC65.csv")
rm(MRIC65)
#######################################################
