...
rcp45bcc65 <- read.csv("Output/UT/rcp45/climstabvegbcc65.csv", sep=",")
rcp45bcc100 <- read.csv("Output/UT/rcp45/climstabvegbcc100.csv", sep=",")
rcp45BNUESM100 <- read.csv("Output/UT/rcp45/climstabvegBNUESM100.csv", sep=",")
rcp45BNUESM65 <- read.csv("Output/UT/rcp45/climstabvegBNUESM65.csv", sep=",")
rcp45CanESM100 <- read.csv("Output/UT/rcp45/climstabvegCanESM100.csv", sep=",")
rcp45CanESM65 <- read.csv("Output/UT/rcp45/climstabvegCanESM65.csv", sep=",")
rcp45CNRMCM100 <- read.csv("Output/UT/rcp45/climstabvegCNRMCM100.csv", sep=",")
rcp45CNRMCM65 <- read.csv("Output/UT/rcp45/climstabvegCNRMCM65.csv", sep=",")
rcp45FGOALSs100 <- read.csv("Output/UT/rcp45/climstabvegFGOALSs100.csv", sep=",")
rcp45FGOALSs65 <- read.csv("Output/UT/rcp45/climstabvegFGOALSs65.csv", sep=",")
rcp45GFDL65 <- read.csv("Output/UT/rcp45/climstabvegGFDL65.csv", sep=",")
rcp45GFDL100 <- read.csv("Output/UT/rcp45/climstabvegGFDL100.csv", sep=",")
rcp45GFDLESML100 <- read.csv("Output/UT/rcp45/climstabvegGFDLESM100.csv", sep=",")
rcp45GFDLESML65 <- read.csv("Output/UT/rcp45/climstabvegGFDLESM65.csv", sep=",")
rcp45MIROC65 <- read.csv("Output/UT/rcp45/climstabvegMIROC65.csv", sep=",")
rcp45MIROC100 <-read.csv("Output/UT/rcp45/climstabvegMIROC100.csv", sep=",")
rcp45MIROCES100 <- read.csv("Output/UT/rcp45/climstabvegMIROCES100.csv", sep=",")
rcp45MIROCES65 <- read.csv("Output/UT/rcp45/climstabvegMIROCES65.csv", sep=",")
rcp45MRIC100 <- read.csv("Output/UT/rcp45/climstabvegMRIC100.csv", sep=",")
rcp45MRIC65 <- read.csv("Output/UT/rcp45/climstabvegMRIC65.csv", sep=",")
rcp45MIROCHEM65 <-read.csv("Output/UT/rcp45/climstabvegMIROCHEM65.csv", sep = ",")
rcp45MIROCHEM100 <-read.csv("Output/UT/rcp45/climstabvegMIROCHEM100.csv",sep = ",")

#do the same with rcp85
#list.files(path = "Output/UT/rcp85",pattern = "climstabveg")
rcp85bcc65 <- read.csv("Output/UT/rcp85/climstabvegbcc65.csv", sep=",")
rcp85bcc100 <- read.csv("Output/UT/rcp85/climstabvegbcc100.csv", sep=",")
rcp85BNUESM100 <- read.csv("Output/UT/rcp85/climstabvegBNUESM100.csv", sep=",")
rcp85BNUESM65 <- read.csv("Output/UT/rcp85/climstabvegBNUESM65.csv", sep=",")
rcp85CanESM100 <- read.csv("Output/UT/rcp85/climstabvegCanESM100.csv", sep=",")
rcp85CanESM65 <- read.csv("Output/UT/rcp85/climstabvegCanESM65.csv", sep=",")
rcp85CNRMCM100 <- read.csv("Output/UT/rcp85/climstabvegCNRMCM100.csv", sep=",")
rcp85CNRMCM65 <- read.csv("Output/UT/rcp85/climstabvegCNRMCM65.csv", sep=",")
rcp85FGOALSs100 <- read.csv("Output/UT/rcp85/climstabvegFGOALSs100.csv", sep=",")
rcp85FGOALSs65 <- read.csv("Output/UT/rcp85/climstabvegFGOALSs65.csv", sep=",")
rcp85GFDL65 <- read.csv("Output/UT/rcp85/climstabvegGFDL65.csv", sep=",")
rcp85GFDL100 <- read.csv("Output/UT/rcp85/climstabvegGFDL100.csv", sep=",")
rcp85GFDLESML100 <- read.csv("Output/UT/rcp85/climstabvegGFDLESM100.csv", sep=",")
rcp85GFDLESML65 <- read.csv("Output/UT/rcp85/climstabvegGFDLESM65.csv", sep=",")
rcp85MIROC65 <- read.csv("Output/UT/rcp85/climstabvegMIROC65.csv", sep=",")
rcp85MIROC100 <-read.csv("Output/UT/rcp85/climstabvegMIROC100.csv", sep=",")
rcp85MIROCES100 <- read.csv("Output/UT/rcp85/climstabvegMIROCES100.csv", sep=",")
rcp85MIROCES65 <- read.csv("Output/UT/rcp85/climstabvegMIROCES65.csv", sep=",")
rcp85MRIC100 <- read.csv("Output/UT/rcp85/climstabvegMRIC100.csv", sep=",")
rcp85MRIC65 <- read.csv("Output/UT/rcp85/climstabvegMRIC65.csv", sep=",")
rcp85MIROCHEM65 <-read.csv("Output/UT/rcp85/climstabvegMIROCHEM65.csv", sep = ",")
rcp85MIROCHEM100 <-read.csv("Output/UT/rcp85/climstabvegMIROCHEM100.csv",sep = ",")
...
write.csv(climstab2100, file ="Output/Climstab2100_UT.csv")
write.csv(climstab2065, file = "Output/Climstab2065_UT.csv")
write.csv(HullV_fut2100, file = "Output/HullV_fut2100_UT.csv)")
write.csv(HullV_fut2065, file = "Output/HullV_fut2065_UT.csv")
write.csv(HullV_hst2065, file = "Output/HullV_hst2065_UT.csv")
write.csv(HullV_hst2100, file = "Output/HullV_hst2100_UT.csv")
